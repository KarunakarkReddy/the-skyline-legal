...
export const practiceAreas: PracticeArea[] = [
  ...
  },
  {
    ...
    desc: "Karnataka state government service and administrative matters before the KSAT.",
    long: "We represent state government employees and administrative litigants before the Karnataka State Administrative Tribunal.",
    keywords: "KSAT Advocate Bengaluru, Karnataka State Administrative Tribunal Lawyer",
  },
  {
    slug: "cat-matters",
    title: "CAT Matters",
  ...
  },
  {
    ...
    long: "We challenge administrative orders, appear in service matters, and represent government employees and departments before CAT, KSAT, and the High Court.",
    keywords: "Administrative Law Expert, CAT Advocate, KSAT Advocate",
  },
  {
    slug: "service-law",
    title: "Service Law",
    ...
    long: "We represent central and state government employees, PSU staff, and officers in service-law disputes before CAT, KSAT, and the High Court of Karnataka.",
